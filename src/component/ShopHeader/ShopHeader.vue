  ...
  <div class="shop-header">
      ...
      <div class="header-content">
        ...
        <div class="shop-message">
          ...
          <span class="shop-message-detail">
            {{info.description}}
            <span>约{{info.deliveryTim}}分钟</span>
          </span>
    ...
    <div class="shop-header-discounts" v-if="info.supports " @click="isShowSupports=true">
      <div class="discounts-left">
        <div class="activity" :class="suportClasses[info.supports[0].type]">
          <span class="content-tag">
    ...
    <div class="activity-sheet" style="display: none;" v-show="isShowSupports">
...
<script type="text/ecmascript-6">
  ...
  export default {
    data(){
      return {
        suportClasses:['activity-green','activity-red','activity-orange'],
